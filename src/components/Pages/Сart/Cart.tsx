...
const Cart = React.memo(() => {
  const { totalCount, cartItems, totalPrice } = useAppUseSelector((state) => state.cartSlice)
  ...
  return (
    <div className="container container--cart">
      <div className="cart">
        ...
        <div className="content__citems">
          {cartItems.map((cartItem) => (
            <CartItem {...cartItem} key={`${cartItem.size}&${cartItem.type}&${cartItem.title}`} />
          ))}
        </div>
        <div className="cart__bottom">
          <div className="cart__bottom-details">
            ...
            <span>
              {' '}
              Сума замовлення: <b>{totalPrice} UAH</b>{' '}
            </span>
          </div>
